...
usb_device_endpoint_struct_t g_UsbDevicePrinterEndpoints[USB_PRINTER_ENDPOINT_COUNT] = {
    ...
    {
        USB_PRINTER_INTERRUPT_ENDPOINT_OUT | (USB_OUT << USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT),
    ...
    {
        USB_PRINTER_INTERRUPT_ENDPOINT_IN | (USB_IN << USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT),
        USB_ENDPOINT_INTERRUPT,
    ...
    {
        USB_WEIGHER_INTERRUPT_ENDPOINT_OUT | (USB_OUT << USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT),
        USB_ENDPOINT_INTERRUPT,
    ...
    {
        USB_WEIGHER_INTERRUPT_ENDPOINT_IN | (USB_IN << USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT),
        USB_ENDPOINT_INTERRUPT,
        FS_WEIGHER_INTERRUPT_IN_PACKET_SIZE,
        0U,
    },
...
/* weigher interface information */
usb_device_interface_struct_t g_UsbDeviceWeigherInterface[] = {
    {
        USB_WEIGHER_INTERFACE_ALTERNATE_0, /* The alternate setting of the interface */
    {
        USB_WEIGHER_ENDPOINT_COUNT,  /* Endpoint count */
        g_UsbDeviceWeigherEndpoints, /* Endpoints handle */
    },
        NULL,
    }
};
...
usb_device_interfaces_struct_t g_UsbDeviceWeigherInterfaces[USB_WEIGHER_INTERFACE_COUNT] = {
    {
        USB_WEIGHER_CLASS,           /* weigher class code */
        USB_WEIGHER_SUBCLASS,        /* weigher subclass code */
        USB_WEIGHER_PROTOCOL,        /* weigher protocol code */
        USB_WEIGHER_INTERFACE_INDEX, /* The interface number of the weigher */
        g_UsbDeviceWeigherInterface, /* Interfaces handle */
        sizeof(g_UsbDeviceWeigherInterface) / sizeof(usb_device_interface_struct_t),
    },
};

usb_device_interface_list_t g_UsbDevicePrinterInterfaceList[USB_DEVICE_CONFIGURATION_COUNT] = {
    {
        USB_PRINTER_INTERFACE_COUNT,  /* The interface count of the printer */
...
usb_device_interface_list_t g_UsbDeviceWeigherInterfaceList[USB_DEVICE_CONFIGURATION_COUNT] = {
    {
        USB_WEIGHER_INTERFACE_COUNT,  /* The interface count of the printer */
        g_UsbDeviceWeigherInterfaces, /* The interfaces handle */
    },
};
...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    */
    ...
    USB_SHORT_GET_LOW(FS_PRINTER_INTERRUPT_IN_PACKET_SIZE), USB_SHORT_GET_HIGH(FS_PRINTER_INTERRUPT_IN_PACKET_SIZE),
    /* Maximum packet size this endpoint is capable of
       sending or receiving when this configuration is
       selected. */
    FS_PRINTER_INTERRUPT_IN_INTERVAL, /* Interval for polling endpoint for data transfers. */
    ...
    /* The address of the endpoint on the USB device
       described by this descriptor. */
    USB_ENDPOINT_INTERRUPT, /* This field describes the endpoint's attributes */
    USB_SHORT_GET_LOW(FS_PRINTER_INTERRUPT_OUT_PACKET_SIZE), USB_SHORT_GET_HIGH(FS_PRINTER_INTERRUPT_OUT_PACKET_SIZE),
    /* Maximum packet size this endpoint is capable of
       sending or receiving when this configuration is
       selected. */
    FS_PRINTER_INTERRUPT_OUT_INTERVAL, /* Interval for polling endpoint for data transfers. */
    ...
    /* The address of the endpoint on the USB device
       described by this descriptor. */
    USB_ENDPOINT_INTERRUPT, /* This field describes the endpoint's attributes */
    USB_SHORT_GET_LOW(FS_WEIGHER_INTERRUPT_IN_PACKET_SIZE), USB_SHORT_GET_HIGH(FS_WEIGHER_INTERRUPT_IN_PACKET_SIZE),
    /* Maximum packet size this endpoint is capable of
       sending or receiving when this configuration is
       selected. */
    FS_WEIGHER_INTERRUPT_IN_INTERVAL, /* Interval for polling endpoint for data transfers. */
    ...
    /* The address of the endpoint on the USB device
       described by this descriptor. */
    USB_ENDPOINT_INTERRUPT, /* This field describes the endpoint's attributes */
    USB_SHORT_GET_LOW(FS_WEIGHER_INTERRUPT_OUT_PACKET_SIZE), USB_SHORT_GET_HIGH(FS_WEIGHER_INTERRUPT_OUT_PACKET_SIZE),
    /* Maximum packet size this endpoint is capable of
       sending or receiving when this configuration is
       selected. */
    FS_WEIGHER_INTERRUPT_OUT_INTERVAL, /* Interval for polling endpoint for data transfers. */
...
usb_status_t USB_DeviceSetSpeed(usb_device_handle handle, uint8_t speed)
{
        ...
        if (descriptorHead->common.bDescriptorType == USB_DESCRIPTOR_TYPE_ENDPOINT)
        {
            if (USB_SPEED_HIGH == speed)
            {
                     ...
                     (descriptorHead->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)))
                {
                    ...
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(HS_PRINTER_INTERRUPT_OUT_PACKET_SIZE,
                          ...
                          (descriptorHead->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)))
                {
                    ...
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(HS_PRINTER_INTERRUPT_IN_PACKET_SIZE,
                                                       descriptorHead->endpoint.wMaxPacketSize);
                }
                     ...
                     (descriptorHead->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)))
                {
                    ...
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(HS_WEIGHER_INTERRUPT_OUT_PACKET_SIZE,
                                                       descriptorHead->endpoint.wMaxPacketSize);
                }
            ...
            else
            {
                     ...
                     (descriptorHead->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)))
                {
                    ...
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(FS_PRINTER_INTERRUPT_OUT_PACKET_SIZE,
                                                       descriptorHead->endpoint.wMaxPacketSize);
                }
                          ...
                          (descriptorHead->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)))
                {
                    ...
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(FS_PRINTER_INTERRUPT_IN_PACKET_SIZE,
                                                       descriptorHead->endpoint.wMaxPacketSize);
                }
                     ...
                     (descriptorHead->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)))
                {
                    ...
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(FS_WEIGHER_INTERRUPT_OUT_PACKET_SIZE,
                                                       descriptorHead->endpoint.wMaxPacketSize);
                }
                          ...
                          (descriptorHead->endpoint.bEndpointAddress & USB_ENDPOINT_NUMBER_MASK)))
                {
                    ...
                    USB_SHORT_TO_LITTLE_ENDIAN_ADDRESS(FS_WEIGHER_INTERRUPT_IN_PACKET_SIZE,
                                                       descriptorHead->endpoint.wMaxPacketSize);
                }
    ...
    for( int i = 0U; i < USB_WEIGHER_INTERFACE_COUNT; i++ )
    {
        if( USB_SPEED_HIGH == speed ) {
            ...
            else if ((g_UsbDeviceWeigherEndpoints[i].endpointAddress &
                      USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_MASK) == USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_IN)
            {
